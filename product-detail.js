document.addEventListener("DOMContentLoaded", () => {
  ...
  // Set up product images (using placeholder images for demo)
  ...
  document.getElementById("productDescription").innerHTML = `
    <p>Experience the ultimate in martial arts equipment with our premium ${product.name.toLowerCase()}. 
    Crafted with precision and care, this product exemplifies the perfect balance of durability and performance.</p>
    
    <h3>Features:</h3>
    <ul>
        <li>Premium quality materials</li>
        <li>Professional-grade construction</li>
        <li>Optimal comfort and flexibility</li>
        <li>Designed for both training and competition</li>
    </ul>

    <h3>Specifications:</h3>
    <ul>
        <li>Material: High-grade synthetic fabric</li>
          ...
          ${suggestedProducts
            ...
            <div class="suggestion-card">
              <a href="product-detail.html?id=${prod.id}" class="product-link">
                <img src="${prod.image}" alt="${prod.name}" class="suggestion-image">
                <h3>${prod.name}</h3>
